def calculator():
    ...
    a = int(input('Введите целое натуральное число а: '))
    b = int(input('Введите целое натуральное число b: '))
    operation = str(input('Введите арифметическую операцию ("+", "-", "*", "/") для чисел: '))
    def addition():
